...
import { addTypeRecipe, createRecipe, getRecipeAll } from '../../redux/action';
            ...
            <div id='conteiner-form'>
                <form  id="form" onSubmit={handleSubmit}>
                    ...
                    <section id='section2'>
                        ...
                        <section id='sectionA'>
                            <div>
                                <label className='title-form'>Titulo: </label><br/>
                                <input className='input-form'type="text" name="title" onChange={changeHandle} value={input.title}></input>
                                {error.title && <p style={{fontWeight:'bold',fontSize: '12px',lineHeight: '0.1em',color:'red'}}>{error.title}</p>}
                            </div>
                            <div>
                                <label className='title-form'>Resumen del plato: </label><br/>
                                <textarea className='cuadro-texto' type="text" name="summary"  onChange={changeHandle} value={input.summary}></textarea>
                                {error.summary && <p style={{fontWeight:'bold',fontSize: '12px',lineHeight: '0.1em',color:'red'}}>{error.summary}</p>}
                            </div>
                            <div id='score-form'>
                                <label className='title-form'>Health score: </label><br/>
                        ...
                        <section id='sectionB'>
                            <div>
                                <label className='title-form'>Paso a paso: </label><br/>
                                <textarea  className='cuadro-texto' type="text" name="instructions" onChange={changeHandle} value={input.instructions}></textarea>
                                {error.instructions && <p style={{fontWeight:'bold',fontSize: '12px',lineHeight: '0.1em',color:'red'}}>{error.instructions}</p>}
                            </div>
                            <div>
                            <label className='title-form'   >Tipos de dieta: </label><br/>
                                <ul className='scroll-diets' >
                                    {typesDiets.map(ele=>{
                                        return(
                                            <div id="box-diets-list" key={ele.id}  >
                        ...
                        <section id='sectionC'>
                            <div>
                                <label className='title-form'>Imagen: </label><br/>
                                <input  className='input-form' type="text" name="image" onChange={changeHandle} value={input.image}></input><br/>
                                {error.image && <p style={{fontWeight:'bold',fontSize: '12px',lineHeight: '0.1em',color:'red'}}>{error.image}</p>} 
                            </div>
                            <div id='box'>
                                <img id="new-img" src={!input.image?imageDefault:input.image} alt={input.image}></img>
                            </div>
                            <button id="btn-submit-form" type="submit">Crear receta</button>
